...
export default function UserProfile() {
    ...
    // variables with sample data for testing
    const [username, setUsername] = useState('johndoe');
    const [description, setDescription] = useState('I love animals!');
    ...
    const [followers, setFollowers] = useState(['johndoe', 'janedoe', 'johndoe2', 'janedoe2']);
    const [following, setFollowing] = useState(['johndoe', 'janedoe', 'johndoe2', 'janedoe2']);
    ...
    <div className="flex h-screen">
        ...
        <div className="flex-1 h-screen">
            ...
            {/* Header Picture Rectangle */}
                <CoverPhoto src={coverPhotoURL} alt={username + " cover photo"} />
            </div>
            ...
            <div id='content-container' className='h-4/5 flex flex-row'>
                ...
                <div className='flex flex-col translate-x-80 w-[calc(100%-20rem)]'>
                    ...
                    <div id='tab-container' className='overflow-y-scroll'>
                        ...
                        {activeTab === 'Media' && (
                            ...
                            {/* if no media... */}
                            <div className='flex flex-col text-center justify-center w-fit h-full'>
                                <i className="fa-solid fa-hippo text-8xl text-grass"></i>
                                <div className='mt-2 font-bold text-grass'>Nothing to see here yet...</div>
                            </div>
