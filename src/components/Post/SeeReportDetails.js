...
export default function PostSnippet({ props }) {
    ...
    return (
      <div className='drop-shadow-sm hover:drop-shadow-md bg-snow w-screen md:w-[650px] min-h-fit rounded-lg p-8 flex'>
        
        <div className='border-2 border-dark_gray bg-snow w-screen md:w-[650px] min-h-fit rounded-lg p-6 flex flex-col'>
            ...
            <div id='post-footer' className='mt-4 flex flex-col w-full relative'>
              <div className='flex flex-row w-full justify-between relative border-dark_gray border-y-2 p-2'>
                <div className='flex flex-col text-sm md:text-base'>
                  <div className='flex flex-row gap-4 items-center'>
                    <p className='text-xl font-bold'>Reason for report:</p>
                    <div className='w-fit h-fit bg-grass text-snow rounded-md px-5 py-1 text-lg font-bold text'>Violence</div>
                  </div>
                  <p className='font-bold mt-3'>Details:</p>
                  <p className='mt-2'>This is bad. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                </div>
