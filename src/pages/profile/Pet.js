        ...
        <div className = "flex">
            ...
            <div className="flex-1 p-8">
                ...
                <div className="absolute mt-0 top-48 ml-72 flex flex-row mr-4 w-10/12 bg-snow">
                    ...
                    <button className="px-10 py-2 text-raisin_black hover:bg-citron hover:text-white focus:outline-none border">Milestones</button>
                    <button className="px-14 py-2 text-raisin_black hover:bg-citron hover:text-white focus:outline-none border">Media</button>
                    <button className="px-10 py-2 text-raisin_black hover:bg-citron hover:text-white focus:outline-none border">Tagged Posts</button>
                </div>
